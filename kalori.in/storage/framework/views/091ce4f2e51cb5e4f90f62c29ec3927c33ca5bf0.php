...
<form action="<?php echo e(route('menu.update',$menu->id)); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="paket" value="<?php echo e($menu->paket); ?>">
    ...
    <div class="form-group">
        ...
        <div class="mb-3">
            <div class="input-group is-invalid">
                ...
                <input type="number" name="harga" value="<?php echo e($menu->harga); ?>" class="form-control"
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='senin_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->senin_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        ...
        <textarea class="form-control" name='senin_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->senin_dinner); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='selasa_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->selasa_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        <label for="exampleFormControlInput1">Dinner</label>
        <textarea class="form-control" name='selasa_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->selasa_dinner); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='rabu_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->rabu_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        <label for="exampleFormControlInput1">Dinner</label>
        <textarea class="form-control" name='rabu_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->rabu_dinner); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='kamis_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->kamis_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        <label for="exampleFormControlInput1">Dinner</label>
        <textarea class="form-control" name='kamis_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->kamis_dinner); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='jumat_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->jumat_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        <label for="exampleFormControlInput1">Dinner</label>
        <textarea class="form-control" name='jumat_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->jumat_dinner); ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name='sabtu_lunch' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->sabtu_lunch); ?></textarea>
    </div>
    <div class="form-group mb-2">
        <label for="exampleFormControlInput1">Dinner</label>
        <textarea class="form-control" name='sabtu_dinner' id="exampleFormControlTextarea1"
            rows="3"><?php echo e($menu->sabtu_dinner); ?></textarea>
    </div>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WAD_TUBES_KALORI.IN\kalori.in\resources\views/Admin/EditMenu.blade.php ENDPATH**/ ?>