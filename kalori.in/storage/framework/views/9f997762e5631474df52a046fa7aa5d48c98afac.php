        ...
        <div class="form-v4-content">
            <div class="form-left" align="center">
                ...
                <div class="d-grid gap-2" ;">
                    <a class="btn btn-danger" href="<?php echo e(route('login')); ?>" role="button"
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- <form class="form-detail" action="<?php echo e(route('register')); ?>" method="post" id="myform">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WAD_TUBES_KALORI.IN\kalori.in\resources\views/auth/register.blade.php ENDPATH**/ ?>