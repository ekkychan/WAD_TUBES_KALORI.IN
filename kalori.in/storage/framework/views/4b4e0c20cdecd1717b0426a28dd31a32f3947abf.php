...
<head>
    ...
    <style>
    body {
        background-image: url("<?php echo e(asset('images/backgroundd.png')); ?>");
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="/home">
                    <img src="<?php echo e(asset('images/Kalori.in webfd.png')); ?>" alt="" />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbars-rs-food">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php endif; ?>
                        <?php else: ?>
                        <li class="nav-item <?php echo e(Request::is('home') ? 'active':''); ?>"><a class="nav-link" href="/home">Home</a></li>
                        ...
                        <li class="nav-item <?php echo e(Request::is('myorder') ? 'active':''); ?>"><a class="nav-link" href="/myorder">MyOrder</a></li>
                </div>
                <div class="nav-item ">
...
</html><?php /**PATH E:\WAD_TUBES_KALORI.IN\kalori.in\resources\views/layouts/app3.blade.php ENDPATH**/ ?>